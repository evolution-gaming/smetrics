...
class CollectionHelperSpec extends AnyFunSuite with Matchers {
  ...
  test("generate combinations for singleton list") {
    List(List(1, 2, 3)).generateCombinations shouldEqual List(List(1), List(2), List(3))
  }

  test("generate combinations for list") {
    List(List(1, 2), List(3, 4)).generateCombinations shouldEqual List(List(1, 3), List(1, 4), List(2, 3), List(2, 4))

    List(List(1, 2), List(3, 4), List(5, 6)).generateCombinations shouldEqual
      List(List(1, 3, 5), List(1, 3, 6), List(1, 4, 5), List(1, 4, 6), List(2, 3, 5), List(2, 3, 6), List(2, 4, 5), List(2, 4, 6))

    List(List(1, 2, 3), List(4, 5, 6)).generateCombinations shouldEqual
