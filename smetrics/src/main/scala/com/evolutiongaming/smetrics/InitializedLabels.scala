...
object InitializedLabels {
  ...
  case object `0` extends InitializedLabels {
  ...
  final case class `1`(name1: String, values1: Nel[String]) extends InitializedLabels {
  ...
  final case class `2`(name1: String, values1: Nel[String], name2: String, values2: Nel[String]) extends InitializedLabels {
  ...
  final case class `3`(
    name1: String, values1: Nel[String],
    name2: String, values2: Nel[String],
    name3: String, values3: Nel[String]
  ) extends InitializedLabels {
  ...
  final case class `4`(
    ...
    name2: String, values2: Nel[String],
    name3: String, values3: Nel[String],
    name4: String, values4: Nel[String]
  ) extends InitializedLabels {
  ...
  final case class `5`(
    ...
    name3: String, values3: Nel[String],
    name4: String, values4: Nel[String],
    name5: String, values5: Nel[String]
  ) extends InitializedLabels {
  ...
  final case class `6`(
    ...
    name4: String, values4: Nel[String],
    name5: String, values5: Nel[String],
    name6: String, values6: Nel[String]
  ) extends InitializedLabels {
  ...
  final case class `7`(
    ...
    name5: String, values5: Nel[String],
    name6: String, values6: Nel[String],
    name7: String, values7: Nel[String]
  ) extends InitializedLabels {

    def names: List[String] = List(name1, name2, name3, name4, name5, name6, name7)

    def values: List[List[String]] =
      List(values1.toList, values2.toList, values3.toList, values4.toList, values5.toList, values6.toList, values7.toList)
  }
}
