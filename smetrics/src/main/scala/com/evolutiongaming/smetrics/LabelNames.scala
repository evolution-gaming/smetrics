...
object LabelNames {
  ...
  def apply(name1: String, name2: String, name3: String, name4: String, name5: String): `5` =
    `5`(name1, name2, name3, name4, name5)

  def apply(name1: String, name2: String, name3: String, name4: String, name5: String, name6: String): `6` =
  ...
  def apply(
      ...
      name6: String,
      name7: String
  ): `7` = `7`(name1, name2, name3, name4, name5, name6, name7)
  ...
  final case class `6`(name1: String, name2: String, name3: String, name4: String, name5: String, name6: String)
      extends LabelNames {
