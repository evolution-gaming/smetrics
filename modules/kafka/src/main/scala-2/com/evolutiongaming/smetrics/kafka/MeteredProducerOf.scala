...
class MeteredProducerOf[F[_]](producerOf: ProducerOf[F],
                              kafkaMetricsRegistry: KafkaMetricsRegistry[F]) extends ProducerOf[F] {
...
object MeteredProducerOf {
  def wrap[F[_]](producerOf: ProducerOf[F],
                 kafkaMetricsRegistry: KafkaMetricsRegistry[F]): MeteredProducerOf[F] =
